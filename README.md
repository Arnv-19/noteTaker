...
- **Study Browser (🌐, Study workspace):** Open a browser tab for reading web pages (reuses the bundled Chromium — no extra dependency). Type a URL or a Google search. Links that open a new tab stay in-app as their own closable tab. Close with **✖ Close** or `Ctrl+W`.
