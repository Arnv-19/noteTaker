...
- **Built-in Web Browser (🌐):** Open a browser tab right in the app (reuses the Chromium engine already bundled — no extra dependency). Type a URL or a Google search, then **📸 Clip** the page — the screenshot is saved and appended to a `Web Clippings.md` note in your folder, so research goes straight into your notes.
